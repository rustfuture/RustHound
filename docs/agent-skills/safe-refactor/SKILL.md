---
name: safe-refactor
description: When refactoring, rewriting, or migrating critical code paths, orchestrate a safe cycle - assess risks, implement, verify, document. Chains pre-mortem and prove-it with built-in implementation phase. Use when the user says "refactor", "rewrite", "migrate", or "clean up" for non-trivial code.
---
...
verification, and documentation. The ceremony slows you down just enough to
