---
name: loose-ends
description: Before declaring work complete, checks for loose ends - unused imports, TODO comments created, missing tests, stale references, incomplete error handling. Use when finishing features, fixing bugs, or before committing changes. The cleanup that always gets skipped.
---
